...
class WorkoutTableViewCell: UITableViewCell {
    ...
    private func setConstrains(){
        ...
        NSLayoutConstraint.activate([
            setNameLabel.topAnchor.constraint(equalTo: topAnchor, constant: 10),
            setNameLabel.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 100),
            setNameLabel.heightAnchor.constraint(equalToConstant: 26),
            setNameLabel.widthAnchor.constraint(equalToConstant: 90)
        ])
        NSLayoutConstraint.activate([
